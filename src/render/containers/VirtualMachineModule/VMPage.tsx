    ...
    <div className={'min-h-screen'}>
      ...
      <div>
        ...
        <div className={''}>
          <div>
            <div>
              intrução : {processador.IR?.nome} <br/>
              descricao: {processador.IR?.descricao}
            </div>
            ...
            <div className={'flex mt-2'}>
              ...
              <div>
                <div className={'flex px-3'}>
                  <div>
                    <NavigationButton path={'/'} text={'Voltar'}/>
                  </div>
                  <div>
                    <button
                      onClick={(e) => handleStart(e)}
                      className={'px-4 py-3 bg-green-500 hover:bg-green-600 rounded text-white'}
                    >
                      iniciar
                    </button>
              ...
              <div className={'grid grid-cols-4 gap-3'}>
                {
                  processador.GPR.map((reg, index) =>
                    (
                      <div>
                        <Registrador nome={"R" + index.toString()} value={reg}  detailColor={'bg-amber-600'} key={index}/>
                      </div>
                    ))
                }
              </div>
